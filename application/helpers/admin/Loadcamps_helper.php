            ...
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex flex-col text-left text-gray-500 font-semibold gap-3 sm:gap-2">
                        ...
                        <p class="text-xs uppercase flex items-center gap-3 underline sm:gap-2">
                            <svg class="w-4 h-4 inline-block text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7 7V5"/>
                            </svg> <a href="$hlink">$hname</a></p>
                    </div>
                </div>
