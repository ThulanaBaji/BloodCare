        ...
        <aside id="sidebar" data-active="<?php echo $active; ?>" class="fixed top-0 left-0 z-40 w-64 h-screen p-3 transition-transform -translate-x-full lg:translate-x-0" aria-label="Sidebar">
            <div class="h-full border border-gray-300 rounded-xl px-3 py-4 overflow-y-auto bg-gradient-to-tr  from-blue-100 to-emerald-50">
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>    
                        <a href="<?php echo base_url().'hospital/requests'; ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-black/5 group">
                    ...
                    <li>
                        <a href="<?php echo base_url().'hospital/organize'; ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-black/5 group">
                    ...
                    <li>
                        <a href="<?php echo base_url().'hospital/appointments'; ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-black/5  group">
                    ...
                    <li>
                        <a href="<?php echo base_url().'hospital/donation'; ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-black/5  group">
                            <svg class="w-5 h-5 text-gray-500 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
                            ...
                            <div class="flex-1 ms-3 whitespace-nowrap">Donation Processing</div>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url().'hospital/notifications'; ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-black/5 group">
                        <svg class="w-5 h-5 text-gray-500 transition duration-75  group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
