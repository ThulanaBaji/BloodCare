            ...
            $footer = $row['status'] == CAMP_CANCELLED ?
                ...
                '<div class="flex justify-end py-1 pt-3">
                    <div class="flex gap-3">
                        <button onclick="editCamp(this)" class="flex-auto text-md font-semibold p-2 w-16 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded" data-id="'.$id.'">edit</button>
                        <button onclick="cancelCamp(this)" class="flex-auto w-16 text-md font-semibold p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded" data-id="'.$id.'">cancel</button>
                    </div>
                </div>';
