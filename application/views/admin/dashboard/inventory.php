...
<div class="max-w-xs w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 relative xl:fixed xl:top-10 xl:right-10">
  <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center">
      ...
      <div>
        <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">3.4k (ml)</h5>
  ...
  <div id="column-chart"></div>
    ...
    <div class="flex w-full max-w-sm sm:max-w-3xl mt-11 xl:mt-0 justify-between gap-1 flex-wrap">
        <div class="flex gap-2 flex-wrap">
            <button onclick="showModal('newInflow')" class="p-2 inline-flex pr-3 items-center rounded bg-red-200 hover:shadow text-red-950 text-sm">
                <svg class="w-5 h-5 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m0 14-4-4m4 4 4-4"/>
                </svg>new inflow
            </button>
            <button onclick="showModal('newOutflow')" class="p-2 inline-flex pr-3 items-center rounded bg-red-200 hover:shadow text-red-950 text-sm">
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto" id="modalbg">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <input type="hidden" id="adjust-adminid" value="" name="adminid">
                <span class="sm:col-span-2 text-gray-500 text-sm">warnings on blood running low and overstocking are determined by the following desired blood levels</span>

                <div class="flex">
                    <div>
                        <label class="block mb-2 mt-3 text-sm font-medium text-gray-900 ">A<sub>positive</sub></label>
                        <input type="number" name="ap" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                    <div>
                        <label class="block mb-2 mt-3 text-sm font-medium text-gray-900 ">A<sub>negative</sub></label>
                        <input type="number" name="an" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                </div>
                ...
                <div class="flex">
                    <div>
                        ...
                        <input type="number" name="bp" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                    <div>
                        <label class="block mb-2 mt-3 text-sm font-medium text-gray-900 ">B<sub>negative</sub></label>
                        <input type="number" name="bn" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                </div>
                ...
                <div class="flex">
                    <div>
                        ...
                        <input type="number" name="abp" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                    <div>
                        <label class="block mb-2 mt-3 text-sm font-medium text-gray-900 ">AB<sub>negative</sub></label>
                        <input type="number" name="abn" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                </div>
                ...
                <div class="flex">
                    <div>
                        ...
                        <input type="number" name="op" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                    <div>
                        <label class="block mb-2 mt-3 text-sm font-medium text-gray-900 ">O<sub>negative</sub></label>
                        <input type="number" name="on" class="relative focus:z-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-r-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                </div>
            </div>
                <div class="h-4"></div>
...
<script>
    ...
    function loadChart (chartid) {
        const options = {
          colors: ["rgb(248, 180, 180)", "rgb(253, 164, 175)"],
          series: [
            {
              name: "Positive",
