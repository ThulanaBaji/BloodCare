<div class="h-full w-full sm:pt-6 grid grid-rows-[auto_1fr] ">
    <div class="w-full flex justify-center items-center pb-8">
        <div class="w-fit flex">
            <a href="#" class="w-24 sm:w-28 p-2 text-xs sm:text-sm font-semibold text-gray-600 bg-gradient-to-tr from-blue-200 to-blue-200 border-gray-300 border rounded-l flex justify-center">Today</a>
            <a href="#" class="w-24 sm:w-28 p-2 text-xs sm:text-sm font-semibold text-gray-600 bg-gradient-to-tr hover:from-gray-300 hover:to-amber-200 border-gray-300 border border-x-0 flex justify-center">Processing</a>
            <a href="#" class="w-24 sm:w-28 p-2 text-xs sm:text-sm font-semibold text-gray-600 bg-gradient-to-tr hover:from-gray-300 hover:to-green-200 hover:bg-gray-300 border-gray-300 border rounded-r flex justify-center">Processed</a>
        </div>
    </div>
        ...
        <div class="block p-6 bg-white border max-w-sm w-full border-gray-200 rounded-lg shadow mb-6 sm:mb-0">
            ...
            <div class="divide-y w-full max-h-32 overflow-y-auto">
                <div class="camp flex justify-between items-center max-w-xs w-full py-2">
                    ...
                    <p class="text-sm font-semibold text-gray-600">Vivekananda Blood camp</p></div>
                    <div class="self-end text-md text-gray-800 font-semibold rounded p-2 flex ">64
                ...
                <div class="camp flex justify-between items-center max-w-xs w-full py-2">
                    <div class="flex items-center gap-2"><div class="flex w-8 h-8 border items-center justify-center rounded-full overflow-hidden">
                        <img src="http://localhost/bloodcare/uploads/camp/profileimages/default.svg" alt="">
                    </div>
                    <p class="text-sm font-semibold text-gray-600">Naitexture 20th</p></div>
                    <div class="self-end text-md text-gray-800 font-semibold rounded p-2 flex ">64
                        <svg class="w-3 h-3 self-center ml-1 fill-gray-500" viewBox="0 0 14 18">
                            <path d="M7 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm2 1H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
                        </svg>
            ...
            <a href="<?= base_url('hospital/donation/todaycamps') ?>" class="inline-flex items-center px-3 py-2 mt-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                View camps
