            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Donation Camps</span>
                    ...
                    <li>
                        <a href="<?php echo base_url().'dashboard/logout'; ?>" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
