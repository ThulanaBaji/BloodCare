...
<html lang="en">
	...
	<body style="background-color: #e23e57;">
		<nav class="navbar navbar-dark bg-primary">
			...
			<ul class="nav">
				<li class="nav-item">
					<a id="btnLogin" class="nav-link btn btn-primary" href="<?php echo base_url().$nav1_link?>"><?php echo $nav1_text;?></a>
				</li>
				<li class="nav-item ml-3">
					<a id="btnRegister" class="nav-link btn btn-light" href="<?php echo base_url().$nav2_link?>"><?php echo $nav2_text;?></a>
				</li>
			</ul> 
		</nav>
